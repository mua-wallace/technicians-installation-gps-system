...
const en: Record<MessageId, string> = {
  ...
  'login.brandSubtitle': 'Installations & Interventions',
  'login.heroTitle': 'Manage your tasks from the field',
  'login.heroBody':
    'Your all-in-one workspace for GPS and fleet device installations and interventions. Fill forms, upload signed fiches, and track every task from start to validation.',
  'login.bullet401': 'Fill installation and intervention forms on any device',
  'login.bulletRoutes': 'Track task progress from assignment to validation',
  'login.bulletState': 'Work offline \u2014 drafts sync when you reconnect',
  'login.secureBadge': 'Secure',
  'login.welcome': 'Welcome back',
  'login.instructions': 'Sign in to access your assigned tasks.',
  'login.credentialsHint': 'Use the credentials provided by your Malambi administrator.',
...
const fr: Record<MessageId, string> = {
  ...
  'login.brandSubtitle': "Installations & Interventions",
  'login.heroTitle': "G\u00e9rez vos t\u00e2ches depuis le terrain",
  'login.heroBody':
    "Votre espace de travail pour les installations et interventions GPS et flottes. Remplissez les fiches, t\u00e9l\u00e9versez les documents sign\u00e9s et suivez chaque t\u00e2che du d\u00e9but \u00e0 la validation.",
  'login.bullet401': "Remplissez les fiches d\u2019installation et d\u2019intervention sur n\u2019importe quel appareil",
  'login.bulletRoutes': "Suivez l\u2019avancement des t\u00e2ches de l\u2019assignation \u00e0 la validation",
  'login.bulletState': "Travaillez hors ligne \u2014 les brouillons se synchronisent \u00e0 la reconnexion",
  'login.secureBadge': "S\u00e9curis\u00e9",
  'login.welcome': "Bon retour",
  'login.instructions': "Connectez-vous pour acc\u00e9der \u00e0 vos t\u00e2ches assign\u00e9es.",
  'login.credentialsHint': "Utilisez les identifiants fournis par votre administrateur Malambi.",
